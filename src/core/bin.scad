 ...
 *          Meaning `subdivide_bin(bin, bin_bin_get_bases(bin))` does **not** exactly correspond to the center of each base!
...
module subdivide_bin(bin, subdivisions) {
    ...
    grid = grid_from_total(subdivisions, infill_size_mm, true);
