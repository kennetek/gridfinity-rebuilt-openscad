...
/**
 * @brief Automatically determined maximum compartment size.
 * @warning Requires `grid_element_current` to be available.
...
function auto_compartment_size(height = undef) =
    let(size_2d = grid_element_get_dimensions(grid_element_current()))
    assert(
