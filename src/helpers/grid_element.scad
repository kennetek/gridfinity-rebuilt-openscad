 ...
 * @details Will either be the center of the element, or the bottom left corner.
 * @param element An opaque "grid_element" data object.
 * @returns A 3d vector, with z always set to 0.
 */
...
//    echo(max_width=max_width,max_height=max_height);
    ...
    text(str(grid_element_get_index(element)),
        halign="center",
        valign="center",
